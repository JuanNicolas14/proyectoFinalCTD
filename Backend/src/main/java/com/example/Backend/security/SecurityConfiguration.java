...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/login","/restaurante","/restaurante/{id}","/usuario/registrar", "/plan", "/usuario/detalle", "/plan/registrar", "/usuario/validar/{id}", "/puntuacion", "/puntuacion/{id}").permitAll()
